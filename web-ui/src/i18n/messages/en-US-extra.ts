const enUSExtra = {
  tasks: {
    ...
    groups: {
      title: 'Task Groups',
      description: 'Group multiple tasks under one unified schedule; run group tasks serially or in parallel.',
      manageButton: 'Task Groups',
      createTitle: 'New Task Group',
      editTitle: 'Edit Task Group',
      createAction: 'New Task Group',
      name: 'Group Name',
      namePlaceholder: 'e.g. iPad Air Watch Group',
      cron: 'Unified Schedule (Cron)',
      cronPlaceholder: 'e.g. 0 9,21 * * *',
      cronHint: 'Group tasks trigger at this time together; leave empty to disable auto scheduling.',
      executionMode: 'Execution Mode',
      modeSerial: 'Serial',
      modeSerialHint: 'Tasks run one by one: the next starts after the previous finishes. Safer for risk control.',
      modeParallel: 'Parallel',
      modeParallelHint: 'All group tasks start at once. Faster but with denser requests.',
      enabled: 'Enable Group',
      noCron: 'No schedule set',
      memberCount: '{count} tasks',
      membersHint: 'Check a task to add it to this group, uncheck to remove (one task belongs to one group):',
      memberRunning: 'Task is running. Stop it before changing group membership.',
      inOtherGroup: 'in another group',
      noTasksAvailable: 'No tasks yet. Create a task first.',
      startNow: 'Run now',
      empty: 'No task groups yet',
      deleteConfirm: 'Delete task group "{name}"? Its {count} tasks will fall back to their own schedules.',
      validation: { nameRequired: 'Group name is required' },
      toasts: {
        created: 'Task group created',
        updated: 'Task group updated',
        saveFailed: 'Failed to save task group',
        deleted: 'Task group deleted',
        deleteFailed: 'Failed to delete task group',
        started: 'Task group triggered',
        startFailed: 'Failed to trigger task group',
        stopped: 'Group tasks stopped',
        stopFailed: 'Failed to stop task group',
        memberAdded: 'Task added to group',
        memberRemoved: 'Task removed from group',
      },
    },
    generation: {
    ...
    form: {
      ...
      group: 'Task Group',
      groupNone: 'No task group',
      groupNoneHint: 'Ungrouped tasks use their own schedule.',
      groupHint: 'Schedule is managed by the task group (current: {cron}).',
      groupNoCron: 'Group has no schedule',
      accountStrategy: {
        auto: 'Auto',
