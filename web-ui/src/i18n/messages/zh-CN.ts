...
const zhCN = {
  ...
  results: {
    ...
    card: {
      ...
      block: '屏蔽',
      unblock: '取消屏蔽',
      annotationSaveFailed: '保存标注失败',
      addNote: '写备注',
      editNote: '编辑',
      notePlaceholder: '写点评价，方便下次快速想起要做什么…',
      noteSaveHint: 'Ctrl+Enter 保存 · Esc 取消',
      addTag: '标签',
      removeTag: '移除标签',
      doneTagging: '完成',
      tagPlaceholder: '输入新标签，回车创建',
      blockReasonTitle: '屏蔽理由（可多选，也可不选）',
      blockAndRecord: '屏蔽并记录',
      blockOnly: '仅屏蔽',
      blockReasonUnmatched: '不符合我的要求',
      blockReasonSeller: '卖家信用差',
      blockReasonUsage: '使用次数太多',
      blockReasonShipping: '不包邮',
      blockReasonPrice: '价格太高',
    },
  },
  logs: {
    title: '运行日志',
