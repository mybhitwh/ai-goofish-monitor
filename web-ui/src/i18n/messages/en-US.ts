...
const enUS = {
  ...
  results: {
    ...
    filters: {
      ...
      hasNote: 'With notes only',
      tagFilterLabel: 'By tag:',
    ...
    card: {
      ...
      addNote: 'Add note',
      editNote: 'Edit',
      notePlaceholder: 'Write down your take so you remember what to do next time...',
      noteSaveHint: 'Ctrl+Enter to save · Esc to cancel',
      addTag: 'Tag',
      removeTag: 'Remove tag',
      doneTagging: 'Done',
      tagPlaceholder: 'Type a new tag and press Enter',
      blockReasonTitle: 'Block reasons (multi-select, optional)',
      blockAndRecord: 'Block & record',
      blockOnly: 'Block only',
      blockReasonUnmatched: 'Not what I want',
      blockReasonSeller: 'Seller trust issues',
      blockReasonUsage: 'Too much usage',
      blockReasonShipping: 'No free shipping',
      blockReasonPrice: 'Overpriced',
    },
  },
  logs: {
    title: 'Logs',
